...
assert.match(app, /p\.memories = arrayOfObjects\(p\.memories\)/);
...
assert.match(app, /Продолжить в чате/);
...
assert.match(app, /b\.index - a\.index/);
...
assert.doesNotMatch(app, /Что связано в тебе/);
assert.doesNotMatch(app, /одна нить/);
