...
assert.match(html, /styles\.css\?v=20260901-commerce-launch/);
...
assert.match(boot, /assetVersion = "20260901-commerce-launch"/);
...
assert.match(app, /Практика между разговорами/);
