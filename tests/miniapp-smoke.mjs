...
assert.match(app, /p\.change_experiment = objectOrEmpty\(p\.change_experiment\)/);
...
assert.match(app, /Время сверить результат/);
assert.match(app, /Пауза тоже часть пути/);
assert.match(app, /function dateOnlyParts\(value\)/);
assert.match(app, /experiment-grid/);
...
assert.match(app, /forget\.disabled = true/);
