...
assert.match(html, /styles\.css\?v=20260824-prepaid-hardening/);
...
assert.match(boot, /assetVersion = "20260824-prepaid-hardening"/);
...
assert.match(app, /до 100 сообщений в день/);
